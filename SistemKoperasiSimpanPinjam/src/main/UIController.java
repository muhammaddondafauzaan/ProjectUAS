...
public class UIController implements Initializable {
    ...
    void btnRefreshIndividu(ActionEvent event) {
        ObservableList<Individu> data = nasabahDataModel.getNasabahIndividu();
    ...
    void btnTambahIndividu(ActionEvent event) {
        ...
        try {
            nasabahDataModel.addNasabahIndividu(individu);
    ...
    void btnRefreshPerusahaan(ActionEvent event) {
        ObservableList<Perusahaan> data = nasabahDataModel.getNasabahPerusahaan();
    ...
    void btnTambahPerusahaan(ActionEvent event) {
        ...
        try {
            nasabahDataModel.addNasabahPerusahaan(perusahaan);
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            nasabahDataModel = new NasabahDAO("MYSQL");

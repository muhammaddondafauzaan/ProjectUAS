...
public class NasabahDAO {
    ...
    public NasabahDAO(String _driver) throws SQLException {
        connection = MyConnection.getConnection(_driver);
    }
    
    public void addNasabahIndividu(Individu _individu) throws SQLException{
    ...
    public void addNasabahPerusahaan(Perusahaan _perusahaan) throws SQLException{
        String sqlNasabah = "INSERT INTO nasabah (nasabah_id, nama, alamat)" + " VALUES (?,?,?)";
    ...
    public ObservableList<Individu> getNasabahIndividu(){
    ...
    public ObservableList<Perusahaan> getNasabahPerusahaan(){
